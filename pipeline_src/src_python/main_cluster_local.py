...
def run_filtering(img_proc: ImageProcessor, cfg_dict: dict, out_base: Path, exp_name: str):
    ...
    if flat_report_data:
        ...
        save_output(flat_report_data, output_dir_reg_report, "registration_stability_report", exp_name)
        save_output(global_stats, output_dir_reg_report, "registration_summary_stats", exp_name)
